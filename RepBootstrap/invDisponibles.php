...
<body>
 ...
 <nav aria-label="breadcrumb">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Investigaciones disponibles</li>
  </ol>
</nav>
...
<!-- <section class="d-flex py-2 bg-color-light ">
  <div class="container">

  </div>
</section> -->

<section class="bgimageInv">
  <div class="hero-content">
    <div class="align-self-center bg-color-light-x py-3">
      <div class="text-center">
        <h1 class="text-light">Investigaciones disponibles</h1>
        <p class="text-light">Búsqueda por título, material, o autor(es)</p>
      </div>
    </div>
      ...
      <div class="align-self-center">
        <div class="main w-100">
          ...
          <div class="input-group">
            <input type="text" class="form-control" id="search-input1" placeholder="Títulos, Materiales, Investigaciones, Artículos...">
          ...
          <div class="mt-3 align-self-center w-100 text-center text-light">
            <!-- Default inline 1-->
            <div class="custom-control custom-checkbox custom-control-inline">
              <input type="checkbox" class="custom-control-input" id="defaultInline1">
              <label class="custom-control-label" for="defaultInline1">Solo artículos</label>
            </div>

            <!-- Default inline 2-->
            <div class="custom-control custom-checkbox custom-control-inline">
              <input type="checkbox" class="custom-control-input" id="defaultInline2">
              <label class="custom-control-label" for="defaultInline2">Solo materiales</label>
            </div>

            <!-- Default inline 3-->
            <div class="custom-control custom-checkbox custom-control-inline">
              <input type="checkbox" class="custom-control-input" id="defaultInline3">
              <label class="custom-control-label" for="defaultInline3">Solo investigaciones</label>
            </div>
          </div>
        </div>
      </div>
