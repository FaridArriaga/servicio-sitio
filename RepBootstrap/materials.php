...
<body>
 ...
 <nav aria-label="breadcrumb">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Materiales y nanomateriales</li>
  </ol>
</nav>

<section class="bgimageMat">
      ...
      <div class="align-self-center">
        <div class="main w-100">
          ...
          <div class="input-group">
            <input type="text" class="form-control" id="search-input1" placeholder="Busque información sobre materiales y nanomateriales">
            <div class="input-group-append">
              <button class="btn btn-primary" id="search-button1" type="button">
                <i class="icon ion-md-search"></i>
              </button>
            </div>
            <div class="text-center w-100 mt-0">
              <button class="btn btn-primary" id="search-button2" type="button" style="display: none">
                <i class="icon ion-md-search lead"></i>
              </button>
            </div>
          </div>
        </div>
...
<section class="d-flex py-4 bg-color-light" id="materials-section">
 <div class="container align-self-center">
   <div class="sidefilter-title">
    <h3 class="text-cyan">Materiales y nanomateriales</h3>
  </div>
  <div class="row row-filter float-lef">
   <div class="col-md-auto">
    <ul class="list-unstyled text-muted" id="filter-list1">
      <li class="list-group-item filter-combo lead">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="defaultInline1">
          <label class="custom-control-label" for="defaultInline1">Historia</label>
        </div>
      </li>
      <li class="list-group-item filter-combo lead">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="defaultInline2">
          <label class="custom-control-label" for="defaultInline2">Características</label>
        </div>
      </li>
      <li class="list-group-item filter-combo lead">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="defaultInline3">
          <label class="custom-control-label" for="defaultInline3">Aplicaciones</label>
        </div>
      </li>
      <li class="list-group-item filter-combo lead">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="defaultInline4">
          <label class="custom-control-label" for="defaultInline4">Ejemplo</label>
        </div>
      </li>
    </ul>

    <ul class="list-inline text-muted text-center lead" id="filter-list2" style="display: none;">
      <li class="list-inline-item filter-combo">
        <div class="custom-control custom-checkbox">
          <input type="checkbox" class="custom-control-input" id="defaultInline1">
          <label class="custom-control-label" for="defaultInline1">Historia</label>
        </div>
  ...
  <div class="col-lg-auto">
    <div class="card my-3 mx-auto" id="mx-4">
      <div class="card-body">
