      ...
      <div class="col-lg-6">
        <form>
          <div class="form-group">
            <label for="exampleInputEmail1">Id de la investigación</label>
            <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Ingrese id">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Contraseña</label>
            <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Contraseña">
          </div>
          <button type="submit" class="btn btn-primary shadow">Ir</button>
        </form>
      </div>
    </div>
  </div>
